                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-grayLight !pt-5">
                                            ...
                                            donec risus eu elit. Non arcu
                                            laoreet lacus, enim lacinia eu
                                            mauris. Lorem nunc nec dictumst urna
                                            nulla sit. Non diam duis non,
                                            rhoncus morbi tortor sollicitudin
                                            sit duis. Arcu duis velit.
                                        </p>
                                        <form
